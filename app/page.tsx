          ...
          >
            ...
            <div className="bg-blue-50 p-4 sm:p-6 rounded-xl border border-blue-200">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">Download Portfolio</h3>
              </div>
              <p className="text-sm sm:text-base text-gray-600 mb-4">
                View my Portfolio.
              </p>
              <a
                href="/vimalanand_advocate_portfolio.pdf"
                target="_blank"
              ...
              >
                ...
                <span className="text-sm sm:text-base">Download Portfolio (PDF)</span>
              </a>
            </div>
          </motion.div>
        </div>
