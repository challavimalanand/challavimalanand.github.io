...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'property dispute lawyer Hyderabad',
    'legal consultation Hyderabad',
    'family law advocate Hyderabad',
    'patent filing services Hyderabad',
    ...
    'property lawyer Hyderabad',
    'divorce lawyer Hyderabad',
    'patent attorney Hyderabad',
    'IP lawyer Hyderabad'
  ].join(', '),
